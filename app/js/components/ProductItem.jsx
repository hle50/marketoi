...
var ProductItem = React.createClass({
    ...
    render: function () {
        return (<div className="col-sm-6 col-md-4 col-lg-3" data-toggle="animation-appear"
                    ...
                    <div className="store-item-info clearfix" style={{"font-size": "12px", "height": "120px"}}>
                        ...
                        <div className="clearfix">
                            <span className="container-of-amount"><a href="#"
                                                                     className="text-muted">{this.props.amount}  {this.props.unit}</a></span>
                            <span className="container-of-amount"><a href="#"
                                                                     className="text-muted">{this.props.label}</a></span>
